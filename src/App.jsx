    ...
    <>
      <main className={"bg-white min-h-screen font-League-Spartan grid place-items-center"}>
        <div className={"max-w-screen-sm px-5 space-y-9 lg:grid lg:grid-cols-[44%,56%] lg:max-w-screen-lg lg:px-[165px] lg:space-y-0 lg:grid-rows-[auto,1fr]"}>
          ...
          {/*  <div*/}
          {/*    className={"bg-light-grayish-magenta space-y-2 py-3 rounded-lg flex flex-col items-center lg:w-[443px] lg:h-[54px] lg:flex lg:flex-row lg:space-x-8 lg:pl-8 lg:ml-[48px] lg:space-y-0"}*/}
          {/*  >*/}
          {/*    <div className={"flex gap-x-2 justify-center"}>*/}
          {/*      <svg className={"w-[16px] h-[15px] lg:w-[17px] lg:h-[16px]"} xmlns="http://www.w3.org/2000/svg">*/}
          {/*        <path*/}
          ...
          {/*  </div>*/}
          {/*  <div*/}
          {/*    className={"bg-light-grayish-magenta space-y-2 py-3 rounded-lg flex flex-col items-center lg:w-[443px] lg:h-[54px] lg:flex lg:flex-row lg:space-x-8 lg:pl-8 lg:ml-[96px] lg:space-y-0"}*/}
          {/*  >*/}
          {/*    <div className={"flex gap-x-2 justify-center"}>*/}
          {/*      <svg className={"w-[16px] h-[15px] lg:w-[17px] lg:h-[16px]"} xmlns="http://www.w3.org/2000/svg">*/}
          {/*        <path*/}
